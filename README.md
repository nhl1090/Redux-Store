...
- [Academind](https://academind.com/)
    - [Tutorials](https://academind.com/tutorials/)
...
- [DevelopedByEd](https://developedbyed.com/)
    - [DevelopedByEd (YouTube)](https://www.youtube.com/@developedbyed)
...
- [egghead](https://app.egghead.io/)
- [JWT](https://jwt.io/)
    - [Introduction to JSON Web Tokens](https://jwt.io/introduction)
- [Kent C. Dodds](https://kentcdodds.com/)
    - [Prop Drilling](https://kentcdodds.com/blog/prop-drilling)
- [LogRocket](https://logrocket.com/)
    - [React Hooks vs Redux: How Hooks and Context replace Redux?](https://blog.logrocket.com/react-hooks-vs-redux-hooks-context-replace-redux/)
...
- [Pusher](https://pusher.com/)
    - [React Context API: What's it all about?](https://pusher.com/blog/react-context-api/)
...
- [SitePoint](https://www.sitepoint.com/)
    - [How to Replace Redux with React Hooks and the React Context API](https://www.sitepoint.com/replace-redux-react-hooks-context-api/)
...
- [Syntax](https://syntax.fm/)
    - [@syntaxfm (YouTube.com)](https://www.youtube.com/@syntaxfm)
    - [What Is Redux?](https://www.youtube.com/watch?v=mhqO-VL6U2I)
- [Veeral Patel (Medium.com)](https://medium.com/@veeralpatel)
